package com.epam.te.task04.entity;
...
public class Tariff {
    ...
    public double getPriceStationaryrNetwork() {
	...
	public String toString() {
		return "\nId: " + id + "\nTariff: " + name + "\nOperator: " + operatorName 
				+ "\nPayroll: " + payroll + "\nCall prices " + "\n\tPrice inside network: " + priceInsideNetwork
				+ "\n\tPrice outside network: " + priceOutsideNetwork
				+ "\n\tPrice stationary network: " + priceStationaryNetwork
				+ "\nSMS price: " + smsPrice + "\nParameters " + "\n\tFavourite number: " + favouriteNumber
				+ "\n\tTariffing: " + tariffing + "\n\tPrice for connection: " + priceForConnection;
	}
}
